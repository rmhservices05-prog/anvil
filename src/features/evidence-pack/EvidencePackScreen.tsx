  ...
  return (
    <div className="space-y-6">
      <SectionHeader
        ...
        description="The export payload is generated by the session engine and downloaded locally as JSON, including session metadata, alerts, timeline, selected detail, metrics, scenario, and evidence."
        ...
        <Card className="space-y-4">
          ...
          {selectedEvidence ? (
            ...
            <div className="rounded-xl border border-white/6 bg-black/20 p-3 text-sm leading-6 text-slate-400">
              Select an evidence item from the overview or choose one below to inspect it here.
            </div>
          )}
      ...
      <Card className="space-y-3">
        ...
        <div className="text-sm leading-6 text-slate-300">
          {state.exportStatus === 'success'
            ? 'The downloadable JSON artifact has been generated locally and mirrors the current session state.'
            : 'Export is ready. Run download JSON to generate the artifact from the current runtime snapshot.'}
        </div>
      </Card>
    </div>
  );
